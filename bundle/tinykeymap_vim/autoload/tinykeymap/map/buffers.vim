...
call tinykeymap#Map('buffers', 'K', '<count>call WinMove("k")', {'desc': 'Window above'})
call tinykeymap#Map('buffers', 'J', '<count>call WinMove("j")', {'desc': 'Window below'})
call tinykeymap#Map('buffers', 'H', '<count>call WinMove("h")', {'desc': 'Left window'})
call tinykeymap#Map('buffers', 'L', '<count>call WinMove("l")', {'desc': 'Right window'})
