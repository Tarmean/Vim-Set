...
call tinykeymap#Map('windows', '<C-j>', 'resize +<count1>', {'desc': 'Increase height'})
...
call tinykeymap#Map('windows', "i", ':TabNext <count>', {'desc': 'Move to right Tab'})
call tinykeymap#Map('windows', "u", ':tabp <count>', {'desc': 'Move to left Tab'})
call tinykeymap#Map('windows', "U", ':call Clone_rel_tab_backwards(1, <count>)', {'desc': 'Next location'})
call tinykeymap#Map('windows', "I", ':call Clone_rel_tab_forwards(1, <count>)', {'desc': 'Previous location'})
